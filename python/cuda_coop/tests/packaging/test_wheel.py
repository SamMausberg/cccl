...
_REQUIRED_PACKAGE_MEMBERS = {
    ...
    "cuda/coop/cutlass/_group_neighbors.py",
    "cuda/coop/cutlass/_group_neighbors.pyi",
    "cuda/coop/cutlass/_group_histogram.py",
    "cuda/coop/cutlass/_group_histogram.pyi",
    "cuda/coop/cutlass/_lowering/_histogram.py",
    "cuda/coop/cutlass/_lowering/_neighbors.py",
    ...
    "cuda/coop/cutlass/_group_reduce_batched.py",
    "cuda/coop/cutlass/_group_reduce_batched.pyi",
    ...
    "cuda/coop/cutlass/_group_run_length.py",
    "cuda/coop/cutlass/_group_run_length.pyi",
    ...
    "cuda/coop/cutlass/_lowering/_run_length.py",
    "cuda/coop/cutlass/_lowering/_reduce_batched.py",
